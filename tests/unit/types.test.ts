...
describe('Type Definitions', () => {
  describe('PosePoint', () => {
    ...
    it('should accept valid coordinate ranges', () => {
      ...
      expect(validPoint.x).toBeWithinRange(0, 1)
      expect(validPoint.y).toBeWithinRange(0, 1)
      expect(validPoint.visibility).toBeWithinRange(0, 1)
    })
  })
  ...
  describe('PerformanceMetrics', () => {
    it('should track performance correctly', () => {
      ...
      expect(metrics.accuracy).toBeWithinRange(0, 1)
    })
  })
})